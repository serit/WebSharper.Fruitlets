...
module Time =
    let private formWrapper label' attrs content =
        div([ attr.``class`` "form-group fruit-form-group"] @ attrs)[
    ...
    let Timepicker (time: Var<int64>) attrs wrapperAttrs label' =
        ...
        div[attr.``class`` "form-inline fruit-form-inline fruit-form-timepicker"][
    ...
    let Datepicker (date: Var<Date>) attrs wrapperAttrs label' =
        ...
        let dayList = [0..31]
        div[attr.``class`` "form-inline fruit-form-inline fruit-form-datepicker"][
